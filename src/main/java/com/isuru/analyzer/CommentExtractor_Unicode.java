 ...
 */
public class CommentExtractor_Unicode {
...
//    private static String filePath_GossipLanka = "./corpus/raw_data/gossip_lanka/raw_data_4";
...
//    private static String filePath_Lankadeepa_all = "./corpus/raw_data";
    ...
    private static String savePath = "./corpus/analyzed/lankadeepa/tagged_unicode_preprocessing_3.csv";


    public static void main(String[] args) {
        File folder = new File(filePath_Lankadeepa);
        File[] listOfFiles = folder.listFiles();
        CommentExtractor_Unicode extractor = new CommentExtractor_Unicode();
...
//            String fileName = file.getName().split(".txt")[0];
            ...
            for (Comment comment : newsArticle.getComments()) {
                if (extractWithoutSentiment || comment.getSentiment().equals(Sentiment.POSITIVE) ||
